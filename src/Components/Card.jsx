    ...
    return (
        ...
        <div className="card">
            ...
            <div className="back">
                ...
                <strong className=' text-gray-200 text-center text-4xl line-height-3 font-sans'>  Get on <br /> Discount <br/> Code</strong>
                </div>
            </div>
            <div className="front">
                <div className="img">
                ...
                <small className="badge">offer</small>
    ...
    .back::before {
        ...
        width: 160px;
        height: 160%;
        background: linear-gradient(90deg, transparent, #C8A882, #C8A882, #C8A882, #C8A882, transparent);
    ...
    #bottom {
        background-color: rgba(200,168,130,0.8);
        left: 50px;
        top: 0px;
        width: 150px;
        height: 150px;
    ...
    #right {
        background-color: rgba(200,168,130,0.6);
        left: 160px;
        top: -80px;
        width: 30px;
        height: 30px;
